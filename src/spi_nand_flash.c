...
unsigned char _ondie_ecc_flag =
    1; /* Ondie ECC : [ToDo :  Init this flag base on diffrent chip ?] */

#define IMAGE_OOB_SIZE                                                         \
  64 /* fix 64 oob buffer size padding after page buffer, no hw ecc info */
...
static const ecc_check_table_entry ecc_check_table[] = {
    ...
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GQ4UAYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F2GQ4UAYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GQ4UBYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GQ4REYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GQ4UEYIS,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GQ5UEYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GQ5REYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F2GQ4UBYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F2GQ4UE9IS,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F4GQ4UBYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F2GQ5UEYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F2GQ5REYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GM7UEYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GM7REYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F2GM7UEYIG,
     0x30, 4, 0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F2GM7REYIG,
     0x30, 4, 0x2, 4},

    /* GigaDevice Type 2 - uses 0x70 mask, value 0x7 (3-bit) */
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F1GQ4UCYIG,
     0x70, 4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F2GQ4UCYIG,
     0x70, 4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_GIGADEVICE, _SPI_NAND_DEVICE_ID_GD5F4GQ4UCYIG,
     0x70, 4, 0x7, 4},
    ...
    /* ESMT */
    {_SPI_NAND_MANUFACTURER_ID_ESMT, _SPI_NAND_DEVICE_ID_F50D1G41LB, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_ESMT, _SPI_NAND_DEVICE_ID_F50L512M41A, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_ESMT, _SPI_NAND_DEVICE_ID_F50L1G41A0, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_ESMT, _SPI_NAND_DEVICE_ID_F50L1G41LB, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_ESMT, _SPI_NAND_DEVICE_ID_F50L2G41LB, 0x30, 4,
     0x2, 4},

    /* Zentel */
    {_SPI_NAND_MANUFACTURER_ID_ZENTEL, _SPI_NAND_DEVICE_ID_A5U12A21ASC, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_ZENTEL, _SPI_NAND_DEVICE_ID_A5U1GA21BWS, 0x30, 4,
     0x2, 4},
    ...
    /* PN */
    {_SPI_NAND_MANUFACTURER_ID_PN, _SPI_NAND_DEVICE_ID_PN26G01AWSIUG, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_PN, _SPI_NAND_DEVICE_ID_PN26G02AWSIUG, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_PN, _SPI_NAND_DEVICE_ID_PN26Q01AWSIUG, 0x30, 4,
     0x2, 4},

    /* ATO */
    {_SPI_NAND_MANUFACTURER_ID_ATO, _SPI_NAND_DEVICE_ID_ATO25D2GA, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_ATO_2, _SPI_NAND_DEVICE_ID_ATO25D2GB, 0x30, 4,
     0x2, 4},

    /* FMS */
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25S01, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25S01A, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25S02A, 0x30, 4, 0x2,
     4},

    /* FMS (Type 2) */
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25G01B, 0x70, 4, 0x7,
     4},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25G02B, 0x70, 4, 0x7,
     4},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25G02C, 0x70, 4, 0x7,
     4},

    /* XTX */
    {_SPI_NAND_MANUFACTURER_ID_XTX, _SPI_NAND_DEVICE_ID_XT26G02B, 0x70, 4, 0x7,
     4},
    {_SPI_NAND_MANUFACTURER_ID_XTX, _SPI_NAND_DEVICE_ID_XT26G01C, 0xF0, 4, 0xF,
     4},
    {_SPI_NAND_MANUFACTURER_ID_XTX, _SPI_NAND_DEVICE_ID_XT26G02C, 0xF0, 4, 0xF,
     4},
    {_SPI_NAND_MANUFACTURER_ID_XTX, _SPI_NAND_DEVICE_ID_XT26G01A, 0x3C, 2, 0x8,
     2},
    {_SPI_NAND_MANUFACTURER_ID_XTX, _SPI_NAND_DEVICE_ID_XT26G02A, 0x30, 4, 0x2,
     4},

    /* MIRA */
    {_SPI_NAND_MANUFACTURER_ID_MIRA, _SPI_NAND_DEVICE_ID_PSU1GS20BN, 0x30, 4,
     0x2, 4},

    /* Biwin */
    {_SPI_NAND_MANUFACTURER_ID_BIWIN, _SPI_NAND_DEVICE_ID_BWJX08U, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_BIWIN, _SPI_NAND_DEVICE_ID_BWET08U, 0x30, 4, 0x2,
     4},

    /* Foresee */
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND02GS2F1, 0x70,
     4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND02GD1F1, 0x70,
     4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND01GS1F1, 0x70,
     4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND01GD1F1, 0x70,
     4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND01GS1Y2, 0x70,
     4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND02GS3Y2, 0x70,
     4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND04GS2Y2, 0x70,
     4, 0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35UQA512M, 0x70, 4,
     0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35UQA001G, 0x70, 4,
     0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35UQA002G, 0x70, 4,
     0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35SQA512M, 0x70, 4,
     0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35SQA001G, 0x70, 4,
     0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35SQA002G, 0x70, 4,
     0x7, 4},

    /* DS */
    {_SPI_NAND_MANUFACTURER_ID_DS, _SPI_NAND_DEVICE_ID_DS35Q2GA, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_DS, _SPI_NAND_DEVICE_ID_DS35M2GA, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_DS, _SPI_NAND_DEVICE_ID_DS35Q1GA, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_DS, _SPI_NAND_DEVICE_ID_DS35M1GA, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_DS, _SPI_NAND_DEVICE_ID_DS35Q2GB, 0x30, 4, 0x2,
     4},
    {_SPI_NAND_MANUFACTURER_ID_DS, _SPI_NAND_DEVICE_ID_DS35M2GB, 0x30, 4, 0x2,
     4},

    /* Fison */
    {_SPI_NAND_MANUFACTURER_ID_FISON, _SPI_NAND_DEVICE_ID_CS11G0T0A0AA, 0x70, 4,
     0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FISON, _SPI_NAND_DEVICE_ID_CS11G1T0A0AA, 0x70, 4,
     0x7, 4},
    {_SPI_NAND_MANUFACTURER_ID_FISON, _SPI_NAND_DEVICE_ID_CS11G0G0A0AA, 0x70, 4,
     0x7, 4},

    /* TYM */
    {_SPI_NAND_MANUFACTURER_ID_TYM, _SPI_NAND_DEVICE_ID_TYM25D2GA01, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_TYM, _SPI_NAND_DEVICE_ID_TYM25D2GA02, 0x30, 4,
     0x2, 4},
    {_SPI_NAND_MANUFACTURER_ID_TYM, _SPI_NAND_DEVICE_ID_TYM25D1GA03, 0x30, 4,
     0x2, 4},

    ECC_CHECK_TABLE_END};

static const ecc_check_table_entry *spi_nand_find_ecc_entry(u8 mfr_id,
                                                            u16 dev_id) {
...
struct SPI_NAND_FLASH_INFO_T
    _current_flash_info_t; /* Store the current flash information */
...
static void spi_nand_select_die(u32 page_number) {
  ...
  if (((ptr_dev_info_t->feature) & SPI_NAND_FLASH_DIE_SELECT_1_HAVE)) {
    ...
    if (_die_id != die_id) {
      ...
      _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                             "spi_nand_protocol_die_select_1: die_id=0x%x\n",
                             die_id);
    }
    ...
    if (_die_id != die_id) {
      ...
      _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                             "spi_nand_protocol_die_select_2: die_id=0x%x\n",
                             die_id);
    }
  }
}
...
static SPI_NAND_FLASH_RTN_T ecc_fail_check(u32 page_number) {
  ...
  _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                         "ecc_fail_check: status = 0x%x\n", status);

  entry =
      spi_nand_find_ecc_entry(ptr_dev_info_t->mfr_id, ptr_dev_info_t->dev_id);
  ...
  if (rtn_status == SPI_NAND_FLASH_RTN_DETECTED_BAD_BLOCK) {
    fprintf(stderr,
            "[ecc_fail_check] : ECC cannot recover detected!, page = 0x%x\n",
            page_number);
  }
...
static SPI_NAND_FLASH_RTN_T spi_nand_block_aligned_check(u32 addr, u32 len) {
  ...
  _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                         "SPI_NAND_BLOCK_ALIGNED_CHECK_check: addr = 0x%x, len "
                         "= 0x%x, block size = 0x%x \n",
                         addr, len, (ptr_dev_info_t->erase_size));

  if (_SPI_NAND_BLOCK_ALIGNED_CHECK(len, (ptr_dev_info_t->erase_size))) {
    len =
        ((len / ptr_dev_info_t->erase_size) + 1) * (ptr_dev_info_t->erase_size);
    _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                           "SPI_NAND_BLOCK_ALIGNED_CHECK_check: erase block "
                           "aligned first check OK, addr:%x len:%x\n",
                           addr, len, (ptr_dev_info_t->erase_size));
  }
  ...
  if (_SPI_NAND_BLOCK_ALIGNED_CHECK(addr, (ptr_dev_info_t->erase_size)) ||
    ...
    _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                           "SPI_NAND_BLOCK_ALIGNED_CHECK_check: erase block "
                           "not aligned, addr:0x%x len:0x%x, blocksize:0x%x\n",
                           addr, len, (ptr_dev_info_t->erase_size));
...
SPI_NAND_FLASH_RTN_T spi_nand_erase_block(u32 block_index) {
  ...
  if (status & _SPI_NAND_VAL_ERASE_FAIL) {
    fprintf(stderr,
            "spi_nand_erase_block : erase block fail, block = 0x%x, status = "
            "0x%x\n",
...
static SPI_NAND_FLASH_RTN_T spi_nand_erase_internal(u32 addr, u32 len) {
  ...
  if (spi_nand_block_aligned_check(addr, len) == SPI_NAND_FLASH_RTN_NO_ERROR) {
    ...
    while (erase_len < len) {
      ...
      _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                             "spi_nand_erase_internal: addr = 0x%x, len = "
                             "0x%x, block_idx = 0x%x\n",
      ...
      if (rtn_status != SPI_NAND_FLASH_RTN_NO_ERROR) {
        // This message might be informational depending on context, keep as
        // _SPI_NAND_PRINTF for now. If it's definitely an error leading to
        // failure, change to fprintf(stderr, ...).
        _SPI_NAND_PRINTF("spi_nand_erase_internal : Erase Fail at addr = 0x%x, "
                         "len = 0x%x, block_idx = 0x%x\n",
                         addr, len, block_index);
...
spi_nand_read_page(u32 page_number,
  ...
  rtn_status =
      spi_nand_load_page_into_cache(page_number); // Store return status
  if (rtn_status == SPI_NAND_FLASH_RTN_DETECTED_BAD_BLOCK) {
    // Error message already printed by ecc_fail_check to stderr if applicable
    // _SPI_NAND_PRINTF("spi_nand_read_page: Bad Block, ECC cannot recovery
    // detected, page = 0x%x\n", page_number); rtn_status is already set
  }

  /* 2. Read whole data from cache of NAND Flash Chip */
  _SPI_NAND_DEBUG_PRINTF(
      SPI_NAND_FLASH_DEBUG_LEVEL_1,
      "spi_nand_read_page: curren_page_num = 0x%x, page_number = 0x%x\n",
  ...
  if ((_current_page_num != page_number)) {
    ...
    _SPI_NAND_DEBUG_PRINTF(
        ...
        "spi_nand_read_page: before read, _current_cache_page:\n");
    _SPI_NAND_DEBUG_PRINTF_ARRAY(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                                 &_current_cache_page[0], _SPI_NAND_CACHE_SIZE);

    if (((ptr_dev_info_t->feature) & SPI_NAND_FLASH_PLANE_SELECT_HAVE)) {
      _plane_select_bit = ((page_number >> 6) & (0x1));

      _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                             "spi_nand_read_page: plane select = 0x%x\n",
                             _plane_select_bit);
    }

    {
      spi_nand_protocol_read_from_cache(
          read_addr, ((ptr_dev_info_t->page_size) + (ptr_dev_info_t->oob_size)),
          &_current_cache_page[0], speed_mode, ptr_dev_info_t->dummy_mode);
    }

    _SPI_NAND_DEBUG_PRINTF(
        SPI_NAND_FLASH_DEBUG_LEVEL_2,
        "spi_nand_read_page: after read, _current_cache_page:\n");
    _SPI_NAND_DEBUG_PRINTF_ARRAY(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                                 &_current_cache_page[0], _SPI_NAND_CACHE_SIZE);

    /* Divide read page into data segment and oob segment  */
    memcpy(&_current_cache_page_data[0], &_current_cache_page[0],
           (ptr_dev_info_t->page_size));

    if (ECC_fcheck) {
      memcpy(&_current_cache_page_oob[0],
             &_current_cache_page[(ptr_dev_info_t->page_size)],
             (ptr_dev_info_t->oob_size));
      memcpy(&_current_cache_page_oob_mapping[0], &_current_cache_page_oob[0],
             (ptr_dev_info_t->oob_size));
    }

    _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                           "spi_nand_read_page: _current_cache_page:\n");
    _SPI_NAND_DEBUG_PRINTF_ARRAY(
        SPI_NAND_FLASH_DEBUG_LEVEL_2, &_current_cache_page[0],
        ((ptr_dev_info_t->page_size) + (ptr_dev_info_t->oob_size)));
    _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                           "spi_nand_read_page: _current_cache_page_oob:\n");
    _SPI_NAND_DEBUG_PRINTF_ARRAY(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                                 &_current_cache_page_oob[0],
                                 (ptr_dev_info_t->oob_size));
    _SPI_NAND_DEBUG_PRINTF(
        SPI_NAND_FLASH_DEBUG_LEVEL_2,
        "spi_nand_read_page: _current_cache_page_oob_mapping:\n");
    _SPI_NAND_DEBUG_PRINTF_ARRAY(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                                 &_current_cache_page_oob_mapping[0],
                                 (ptr_dev_info_t->oob_size));
...
static SPI_NAND_FLASH_RTN_T
spi_nand_write_page(u32 page_number, u32 data_offset, u8 *ptr_data,
                    u32 data_len, u32 oob_offset __attribute__((unused)),
                    u8 *ptr_oob, u32 oob_len,
  ...
  rtn_status = spi_nand_read_page(page_number,
                                  (SPI_NAND_FLASH_READ_SPEED_MODE_T)speed_mode);
  if (Skip_BAD_page &&
      (rtn_status ==
       SPI_NAND_FLASH_RTN_DETECTED_BAD_BLOCK)) { /* skip BAD page, go to next
                                                    page */
  ...
  memcpy(&_current_cache_page[0], &_current_cache_page_data[0],
         ptr_dev_info_t->page_size);
  ...
  if (ECC_fcheck && oob_len > 0) /* Write OOB */
  {
    ...
    if (ptr_dev_info_t->oob_size)
      memcpy(&_current_cache_page[ptr_dev_info_t->page_size],
             &_current_cache_page_oob[0], ptr_dev_info_t->oob_size);
  }

  _SPI_NAND_DEBUG_PRINTF(
      SPI_NAND_FLASH_DEBUG_LEVEL_2,
      "spi_nand_write_page: page = 0x%x, data_offset = 0x%x, date_len = 0x%x, "
      "oob_offset = 0x%x, oob_len = 0x%x\n",
  ...
  if (((ptr_dev_info_t->feature) & SPI_NAND_FLASH_PLANE_SELECT_HAVE)) {
    ...
    _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_2,
                           "spi_nand_write_page: _plane_select_bit = 0x%x\n",
                           _plane_select_bit);
  }
  ...
  if (((ptr_dev_info_t->mfr_id) == _SPI_NAND_MANUFACTURER_ID_GIGADEVICE) ||
      ...
      (((ptr_dev_info_t->mfr_id) == _SPI_NAND_MANUFACTURER_ID_ATO) &&
       ((ptr_dev_info_t->dev_id) == _SPI_NAND_DEVICE_ID_ATO25D2GA))) {
    {
      spi_nand_protocol_program_load(
          write_addr, &_current_cache_page[0],
          ((ptr_dev_info_t->page_size) + (ptr_dev_info_t->oob_size)),
          speed_mode);
    }
  ...
  if (status & _SPI_NAND_VAL_PROGRAM_FAIL) {
    fprintf(stderr,
            "spi_nand_write_page : Program Fail at addr_offset = 0x%x, "
            "page_number = 0x%x, status = 0x%x\n",
...
static SPI_NAND_FLASH_RTN_T
spi_nand_write_internal(u32 dst_addr, u32 len, u32 *ptr_rtn_len, u8 *ptr_buf,
                        SPI_NAND_FLASH_WRITE_SPEED_MODE_T speed_mode) {
  ...
  *ptr_rtn_len = 0;
  ...
  _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                         "spi_nand_write_internal: remain_len = 0x%x\n",
                         remain_len);
  ...
  while (remain_len > 0) {
    ...
    _SPI_NAND_DEBUG_PRINTF(
        SPI_NAND_FLASH_DEBUG_LEVEL_1,
        "\nspi_nand_write_internal: addr_offset = 0x%x, page_number = 0x%x, "
        "remain_len = 0x%x, page_size = 0x%x\n",
        addr_offset, page_number, remain_len, (ptr_dev_info_t->page_size));
    if (((addr_offset + remain_len) >
         (ptr_dev_info_t->page_size))) /* data cross over than 1-page range */
    {
    ...
    rtn_status = spi_nand_write_page(page_number, addr_offset,
                                     &(ptr_buf[len - remain_len]), data_len, 0,
                                     NULL, 0, speed_mode);
...
static SPI_NAND_FLASH_RTN_T
spi_nand_read_internal(u32 addr, u32 len, u8 *ptr_rtn_buf,
                       SPI_NAND_FLASH_READ_SPEED_MODE_T speed_mode,
  ...
  *status = SPI_NAND_FLASH_RTN_NO_ERROR;
  ...
  while (remain_len > 0) {
    ...
    _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                           "spi_nand_read_internal: read_addr = 0x%x, "
                           "page_number = 0x%x, data_offset = 0x%x\n",
                           physical_read_addr, page_number, data_offset);

    rtn_status = spi_nand_read_page(
        page_number, (SPI_NAND_FLASH_READ_SPEED_MODE_T)speed_mode);
    if (rtn_status == SPI_NAND_FLASH_RTN_DETECTED_BAD_BLOCK) {
      if (!Skip_BAD_page) {
    ...
    if ((data_offset + remain_len) < ptr_dev_info_t->page_size) {
      memcpy(&ptr_rtn_buf[len - remain_len],
             &_current_cache_page_data[data_offset],
             (sizeof(unsigned char) * remain_len));
      remain_len = 0;
    } else {
      memcpy(
          &ptr_rtn_buf[len - remain_len],
          &_current_cache_page_data[data_offset],
          (sizeof(unsigned char) * (ptr_dev_info_t->page_size - data_offset)));
...
static const struct manufacturer_init_entry mfg_init_table[] = {
    ...
    {_SPI_NAND_MANUFACTURER_ID_ESMT, _SPI_NAND_DEVICE_ID_F50D1G41LB,
     MF_INIT_DIRECT, 0x83},
    {_SPI_NAND_MANUFACTURER_ID_ESMT, _SPI_NAND_DEVICE_ID_F50L1G41LB,
     MF_INIT_DIRECT, 0x83},
    {_SPI_NAND_MANUFACTURER_ID_ESMT, _SPI_NAND_DEVICE_ID_F50L2G41LB,
     MF_INIT_DIRECT, 0x83},
    {_SPI_NAND_MANUFACTURER_ID_ZENTEL, _SPI_NAND_DEVICE_ID_A5U12A21ASC, 0,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_ZENTEL, _SPI_NAND_DEVICE_ID_A5U1GA21BWS, 0,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_PN, _SPI_NAND_DEVICE_ID_PN26G01AWSIUG,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_PN, _SPI_NAND_DEVICE_ID_PN26G02AWSIUG,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_PN, _SPI_NAND_DEVICE_ID_PN26Q01AWSIUG,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25S01, MF_INIT_NOLOG,
     0x87},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25S01A, MF_INIT_NOLOG,
     0x87},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25S02A, MF_INIT_NOLOG,
     0x87},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25G01B, MF_INIT_QUAD,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25G02B, MF_INIT_QUAD,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FM, _SPI_NAND_DEVICE_ID_FM25G02C, MF_INIT_QUAD,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_XTX, _SPI_NAND_DEVICE_ID_XT26G02B, MF_INIT_QUAD,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_XTX, _SPI_NAND_DEVICE_ID_XT26G02A, MF_INIT_QUAD,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_XTX, _SPI_NAND_DEVICE_ID_XT26G02C, MF_INIT_QUAD,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_MIRA, _SPI_NAND_DEVICE_ID_PSU1GS20BN, 0, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_BIWIN, _SPI_NAND_DEVICE_ID_BWJX08U, MF_INIT_QUAD,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_BIWIN, _SPI_NAND_DEVICE_ID_BWET08U, MF_INIT_QUAD,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND02GS2F1,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND02GD1F1,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND01GS1F1,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND01GD1F1,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND01GS1Y2,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND02GS3Y2,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_FS35ND04GS2Y2,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35UQA512M,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35UQA001G,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35UQA002G,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35SQA512M,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35SQA001G,
     MF_INIT_QUAD, 0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FORESEE, _SPI_NAND_DEVICE_ID_F35SQA002G,
     MF_INIT_QUAD, 0xC7},
    ...
    {_SPI_NAND_MANUFACTURER_ID_FISON, _SPI_NAND_DEVICE_ID_CS11G0T0A0AA, 0,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FISON, _SPI_NAND_DEVICE_ID_CS11G1T0A0AA, 0,
     0xC7},
    {_SPI_NAND_MANUFACTURER_ID_FISON, _SPI_NAND_DEVICE_ID_CS11G0G0A0AA, 0,
     0xC7},
...
static void spi_nand_winbond_init(struct SPI_NAND_FLASH_INFO_T *ptr_device_t) {
  ...
  for (int die = 0; die <= 1; die++) {
    if (die == 1 &&
        !((ptr_device_t->feature) & SPI_NAND_FLASH_DIE_SELECT_1_HAVE))
      break;
...
static const struct manufacturer_init_entry *mfg_init_lookup(u8 mfr_id,
                                                             u8 dev_id) {
  const int n = sizeof(mfg_init_table) / sizeof(mfg_init_table[0]);
  int i;

  for (i = 0; i < n; i++) {
    if (mfg_init_table[i].mfr_id == mfr_id && mfg_init_table[i].dev_id != 0 &&
...
static int mfg_die_select_type(const struct SPI_NAND_FLASH_INFO_T *dev) {
  if (dev->feature & SPI_NAND_FLASH_DIE_SELECT_2_HAVE)
    return 2;
  if (dev->feature & SPI_NAND_FLASH_DIE_SELECT_1_HAVE)
    return 1;
  return 0;
}

static void mfg_init_per_die(const struct SPI_NAND_FLASH_INFO_T *dev
...
static void
spi_nand_manufacturer_init(struct SPI_NAND_FLASH_INFO_T *ptr_device_t) {
  _SPI_NAND_DEBUG_PRINTF(
      SPI_NAND_FLASH_DEBUG_LEVEL_1,
...
static SPI_NAND_FLASH_RTN_T
spi_nand_compare(const struct SPI_NAND_FLASH_INFO_T *ptr_rtn_device_t,
  ...
  if (spi_nand_flash_table->dev_id_2 == 0) {
    _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                           ...
                           spi_nand_flash_table->mfr_id,
                           spi_nand_flash_table->dev_id);
...
static void
spi_nand_populate_device_info(struct SPI_NAND_FLASH_INFO_T *target_info,
  ...
  erase_oob_size = (table_entry->erase_size / table_entry->page_size) *
                   table_entry->oob_size;
  target_info->erase_size = ECC_fcheck
                                ? table_entry->erase_size
                                : table_entry->erase_size + erase_oob_size;
  target_info->page_size =
      ECC_fcheck ? table_entry->page_size : table_entry->page_size + oob_size;
...
spi_nand_probe(struct SPI_NAND_FLASH_INFO_T *ptr_rtn_device_t) {
  ...
  for (i = 0; i < table_size; i++) {
    if (spi_nand_compare(ptr_rtn_device_t, &spi_nand_flash_tables[i]) ==
        SPI_NAND_FLASH_RTN_NO_ERROR) {
      spi_nand_populate_device_info(ptr_rtn_device_t,
                                    &spi_nand_flash_tables[i]);
  ...
  if (rtn_status != SPI_NAND_FLASH_RTN_NO_ERROR) {
    /* Another protocol for read id  (For example, the GigaDevice SPI NAND chip
     * for Type C */
    _SPI_NAND_SEMAPHORE_LOCK();
  ...
  if (rtn_status != SPI_NAND_FLASH_RTN_NO_ERROR) {
    /* Another protocol for read id (For example, the Toshiba/KIOXIA SPI NAND
     * chip */
    _SPI_NAND_SEMAPHORE_LOCK();
  ...
  if (ptr_rtn_device_t->dev_id_2 == 0) {
    _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                           "spi_nand_probe: mfr_id = 0x%x, dev_id = 0x%x\n",
                           ptr_rtn_device_t->mfr_id, ptr_rtn_device_t->dev_id);
  } else {
    _SPI_NAND_DEBUG_PRINTF(
        SPI_NAND_FLASH_DEBUG_LEVEL_1,
        "spi_nand_probe: mfr_id = 0x%x, dev_id = 0x%x, dev_id_2 = 0x%x\n",
        ptr_rtn_device_t->mfr_id, ptr_rtn_device_t->dev_id,
        ptr_rtn_device_t->dev_id_2);
  }
...
SPI_NAND_FLASH_RTN_T SPI_NAND_Flash_Init(u32 rom_base __attribute__((unused))) {
  ...
  if (spi_nand_probe(&_current_flash_info_t) != SPI_NAND_FLASH_RTN_NO_ERROR) {
    ...
    _SPI_NAND_PRINTF(
        "Detected SPI NAND Flash: %s, Flash Size: %dMB, OOB Size: %ldB\n",
        _current_flash_info_t.ptr_name,
        ECC_fcheck ? _current_flash_info_t.device_size >> 20
                   : (_current_flash_info_t.device_size - ecc_size) >> 20,
        OOB_size ? (unsigned long)OOB_size : bmt_oob_size);
...
SPI_NAND_Flash_Get_Flash_Info(struct SPI_NAND_FLASH_INFO_T *ptr_rtn_into_t) {
  struct SPI_NAND_FLASH_INFO_T *ptr_dev_info_t;
  SPI_NAND_FLASH_RTN_T rtn_status = SPI_NAND_FLASH_RTN_NO_ERROR;
...
SPI_NAND_FLASH_RTN_T
SPI_NAND_Flash_Set_Flash_Info(struct SPI_NAND_FLASH_INFO_T *ptr_rtn_into_t) {
  struct SPI_NAND_FLASH_INFO_T *ptr_dev_info_t;
  SPI_NAND_FLASH_RTN_T rtn_status = SPI_NAND_FLASH_RTN_NO_ERROR;
...
SPI_NAND_FLASH_RTN_T
SPI_NAND_Flash_Write_Nbyte(u32 dst_addr, u32 len, u32 *ptr_rtn_len, u8 *ptr_buf,
                           SPI_NAND_FLASH_WRITE_SPEED_MODE_T speed_node) {
  SPI_NAND_FLASH_RTN_T rtn_status = SPI_NAND_FLASH_RTN_NO_ERROR;

  rtn_status =
      spi_nand_write_internal(dst_addr, len, ptr_rtn_len, ptr_buf, speed_node);
...
u32 SPI_NAND_Flash_Read_NByte(u32 addr, u32 len, u32 *retlen, u8 *buf,
                              SPI_NAND_FLASH_READ_SPEED_MODE_T speed_mode,
                              SPI_NAND_FLASH_RTN_T *status) {
  SPI_NAND_FLASH_RTN_T rtn_status =
      spi_nand_read_internal(addr, len, buf, speed_mode, status);
  *retlen = len;
  return rtn_status;
}
...
unsigned char SPI_NAND_Flash_Read_Byte(unsigned long addr,
  ...
  _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                         "SPI_NAND_Flash_Read_Byte : buf = 0x%x\n", buf[0]);
  return buf[0];
}
...
SPI_NAND_FLASH_RTN_T SPI_NAND_Flash_Enable_OnDie_ECC(void) {
  ...
  if (((ptr_dev_info_t->feature) & SPI_NAND_FLASH_DIE_SELECT_1_HAVE)) {
    ...
    for (i = 0; i < die_num; i++) {
      ...
      _SPI_NAND_DEBUG_PRINTF(
          SPI_NAND_FLASH_DEBUG_LEVEL_1,
          "before setting : SPI_NAND_Flash_Enable_OnDie_ECC, status reg = "
          "0x%x\n",
          feature);
      if (ECC_fcheck)
        feature |= 0x10;
      ...
      spi_nand_protocol_get_status_reg_2(&feature);
      _SPI_NAND_DEBUG_PRINTF(SPI_NAND_FLASH_DEBUG_LEVEL_1,
                             "after setting : SPI_NAND_Flash_Enable_OnDie_ECC, "
                             "status reg = 0x%x\n",
                             feature);
    }
  } else if (((ptr_dev_info_t->feature) & SPI_NAND_FLASH_DIE_SELECT_2_HAVE)) {
    ...
    if (((ptr_dev_info_t->mfr_id) == _SPI_NAND_MANUFACTURER_ID_PN) ||
        ...
        ((ptr_dev_info_t->mfr_id) == _SPI_NAND_MANUFACTURER_ID_FORESEE) ||
        (((ptr_dev_info_t->mfr_id) == _SPI_NAND_MANUFACTURER_ID_XTX) &&
         ((ptr_dev_info_t->dev_id) == _SPI_NAND_DEVICE_ID_XT26G02B))) {
      spi_nand_protocol_get_feature(_SPI_NAND_ADDR_ECC, &feature);
      _SPI_NAND_DEBUG_PRINTF(
          SPI_NAND_FLASH_DEBUG_LEVEL_1,
          "before setting : SPI_NAND_Flash_Enable_OnDie_ECC, ecc reg = 0x%x\n",
          feature);
      if (ECC_fcheck)
        feature |= 0x10;
      else
      ...
      _SPI_NAND_DEBUG_PRINTF(
          SPI_NAND_FLASH_DEBUG_LEVEL_1,
          "after setting : SPI_NAND_Flash_Enable_OnDie_ECC, ecc reg = 0x%x\n",
          feature);
    } else {
      spi_nand_protocol_get_status_reg_2(&feature);
      _SPI_NAND_DEBUG_PRINTF(
...
int nandflash_read(unsigned long from, unsigned long len, unsigned long *retlen,
                   unsigned char *buf, SPI_NAND_FLASH_RTN_T *status) {
  struct SPI_NAND_FLASH_INFO_T *ptr_dev_info_t;

  ptr_dev_info_t = _SPI_NAND_GET_DEVICE_INFO_PTR;

  timer_start();
  if (SPI_NAND_Flash_Read_NByte(from, len, (u32 *)retlen, buf,
...
int nandflash_write(unsigned long to, unsigned long len, unsigned long *retlen,
                    unsigned char *buf) {
  struct SPI_NAND_FLASH_INFO_T *ptr_dev_info_t;
...
int snand_read(unsigned char *buf, unsigned long from, unsigned long len) {
  ...
  if (!nandflash_read((unsigned long)from, (unsigned long)len, &retlen, buf,
                      &status))
    return len;
